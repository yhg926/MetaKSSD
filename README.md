...
Note: 
MetaKSSD is ideally for prokaryotic metagenomic NGS Whole genome sequecing (WGS) data. It currently not support amplican (e.g. 16S) data; Virus metagenome might not be detected using our default 4096-fold reduction (L3K*.shuf) and GTDB markerDB.   
